...
//   const agentAttachMessage = Convert.toAgentAttachMessage(json);
...
//   const automationProvenance = Convert.toAutomationProvenance(json);
...
//   const filesEditedMessage = Convert.toFilesEditedMessage(json);
//   const fSChangedMessage = Convert.toFSChangedMessage(json);
//   const fSDeleteMessage = Convert.toFSDeleteMessage(json);
//   const fSDeleteResult = Convert.toFSDeleteResult(json);
//   const fSDeleteResultMessage = Convert.toFSDeleteResultMessage(json);
...
//   const hookNotificationMessage = Convert.toHookNotificationMessage(json);
//   const hookStopFailureMessage = Convert.toHookStopFailureMessage(json);
...
//   const installBundledPluginMessage = Convert.toInstallBundledPluginMessage(json);
...
//   const listPastConversationsMessage = Convert.toListPastConversationsMessage(json);
...
//   const markdownAnnotation = Convert.toMarkdownAnnotation(json);
//   const markdownAnnotationAnchor = Convert.toMarkdownAnnotationAnchor(json);
//   const markdownAnnotationsClearMessage = Convert.toMarkdownAnnotationsClearMessage(json);
//   const markdownAnnotationsClearResultMessage = Convert.toMarkdownAnnotationsClearResultMessage(json);
//   const markdownAnnotationsGetMessage = Convert.toMarkdownAnnotationsGetMessage(json);
//   const markdownAnnotationsGetResultMessage = Convert.toMarkdownAnnotationsGetResultMessage(json);
//   const markdownAnnotationsSaveMessage = Convert.toMarkdownAnnotationsSaveMessage(json);
//   const markdownAnnotationsSaveResultMessage = Convert.toMarkdownAnnotationsSaveResultMessage(json);
...
//   const pullRequestProvenance = Convert.toPullRequestProvenance(json);
...
//   const seedNoteResultMessage = Convert.toSeedNoteResultMessage(json);
...
//   const seedTransitionResultMessage = Convert.toSeedTransitionResultMessage(json);
//   const seedVar = Convert.toSeedVar(json);
//   const seedWatchMessage = Convert.toSeedWatchMessage(json);
//   const seedWatchResult = Convert.toSeedWatchResult(json);
...
//   const sessionAnnotationsClearResultMessage = Convert.toSessionAnnotationsClearResultMessage(json);
//   const sessionAnnotationsGetMessage = Convert.toSessionAnnotationsGetMessage(json);
//   const sessionAnnotationsGetResultMessage = Convert.toSessionAnnotationsGetResultMessage(json);
//   const sessionAnnotationsSaveMessage = Convert.toSessionAnnotationsSaveMessage(json);
...
//   const sessionMessage = Convert.toSessionMessage(json);
//   const sessionMessageWindowStatus = Convert.toSessionMessageWindowStatus(json);
...
export interface ActivityStatusMessage {
    cmd: ActivityStatusMessageCmd;
    [property: string]: any;
}

export enum ActivityStatusMessageCmd {
...
export interface AgentAttachMessage {
    cmd: AgentAttachMessageCmd;
    id:  string;
    [property: string]: any;
}

export enum AgentAttachMessageCmd {
    AgentAttach = "agent_attach",
}

export interface AgentClearQueueMessage {
    cmd: AgentClearQueueMessageCmd;
    id:  string;
    [property: string]: any;
}

export enum AgentClearQueueMessageCmd {
    AgentClearQueue = "agent_clear_queue",
}

export interface AgentEventMessage {
    body:  { [key: string]: any };
    event: AgentEventMessageEvent;
    id:    string;
    kind:  string;
    seq:   number;
    [property: string]: any;
...
export enum AgentEventMessageEvent {
    AgentEvent = "agent_event",
}

export interface AgentHistoryMessage {
    before: string;
    cmd:    AgentHistoryMessageCmd;
    id:     string;
    [property: string]: any;
}
...
export enum AgentPromptMessageCmd {
    AgentPrompt = "agent_prompt",
}

export interface AgentSetModelMessage {
    cmd:   AgentSetModelMessageCmd;
    id:    string;
    model: string;
    [property: string]: any;
}

export enum AgentSetModelMessageCmd {
    AgentSetModel = "agent_set_model",
}

export interface AgentToolDetailMessage {
    call_id: string;
    cmd:     AgentToolDetailMessageCmd;
    full?:   boolean;
    id:      string;
    [property: string]: any;
}
...
export enum AutomationDeleteMessageCmd {
...
export enum ClearSessionActivityMessageCmd {
    ClearSessionActivity = "clear_session_activity",
}
...
export interface ClientEvictionNoticeMessage {
    event:                ClientEvictionNoticeMessageEvent;
    evicted_at:           string;
    reason:               string;
...
export enum ClientEvictionNoticeMessageEvent {
    ClientEvictionNotice = "client_eviction_notice",
}
...
export interface FilesEditedMessage {
    cmd:   FilesEditedMessageCmd;
    id:    string;
    paths: string[];
    [property: string]: any;
}

export enum FilesEditedMessageCmd {
...
export enum FSDeleteMessageCmd {
    FSDelete = "fs_delete",
}
...
export interface FSDeleteResultMessage {
    error?:     string;
    event:      FSDeleteResultMessageEvent;
    request_id: string;
    result?:    FSDeleteResultMessageResult;
    success:    boolean;
    [property: string]: any;
}

export enum FSDeleteResultMessageEvent {
    FSDeleteResult = "fs_delete_result",
}

export interface FSDeleteResultMessageResult {
    path: string;
    [property: string]: any;
}
...
export enum FSRenameMessageCmd {
    FSRename = "fs_rename",
}
...
export interface FSRenameResultMessage {
    error?:     string;
    event:      FSRenameResultMessageEvent;
    request_id: string;
    result?:    FSRenameResultMessageResult;
    success:    boolean;
    [property: string]: any;
}

export enum FSRenameResultMessageEvent {
    FSRenameResult = "fs_rename_result",
}

export interface FSRenameResultMessageResult {
    new_path: string;
    path:     string;
    [property: string]: any;
}
...
export interface HookCompactionMessage {
    active:   boolean;
    cmd:      HookCompactionMessageCmd;
    id:       string;
    trigger?: string;
    [property: string]: any;
}

export enum HookCompactionMessageCmd {
    HookCompaction = "hook_compaction",
}

export interface HookNotificationMessage {
    cmd:               HookNotificationMessageCmd;
    id:                string;
    message?:          string;
...
export enum HookNotificationMessageCmd {
    HookNotification = "hook_notification",
}

export interface HookStopFailureMessage {
    cmd:            HookStopFailureMessageCmd;
...
export enum HookStopFailureMessageCmd {
...
export interface InstallBundledPluginMessage {
    cmd:  InstallBundledPluginMessageCmd;
    name: string;
    [property: string]: any;
}

export enum InstallBundledPluginMessageCmd {
    InstallBundledPlugin = "install_bundled_plugin",
}
...
export enum JournalAppendMessageCmd {
...
export interface ListPastConversationsMessage {
    cmd:        ListPastConversationsMessageCmd;
    request_id: string;
    [property: string]: any;
}

export enum ListPastConversationsMessageCmd {
    ListPastConversations = "list_past_conversations",
}
...
export enum MarkdownAnnotationsClearMessageCmd {
    MarkdownAnnotationsClear = "markdown_annotations_clear",
}
...
export enum MarkdownAnnotationsClearResultMessageEvent {
    MarkdownAnnotationsClearResult = "markdown_annotations_clear_result",
}
...
export enum MarkdownAnnotationsGetMessageCmd {
    MarkdownAnnotationsGet = "markdown_annotations_get",
}
...
export enum MarkdownAnnotationsGetResultMessageEvent {
    MarkdownAnnotationsGetResult = "markdown_annotations_get_result",
}
...
export enum MarkdownAnnotationsSaveMessageCmd {
    MarkdownAnnotationsSave = "markdown_annotations_save",
}
...
export enum MarkdownAnnotationsSaveResultMessageEvent {
    MarkdownAnnotationsSaveResult = "markdown_annotations_save_result",
}
...
export enum MarkdownAnnotationsSubmitMessageCmd {
    MarkdownAnnotationsSubmit = "markdown_annotations_submit",
}
...
export enum MarkdownAnnotationsSubmitResultMessageEvent {
    MarkdownAnnotationsSubmitResult = "markdown_annotations_submit_result",
}
...
export enum OpenSentFilesMessageCmd {
    OpenSentFiles = "open_sent_files",
}
...
export interface PastConversationsResultMessage {
    conversations: ConversationElement[];
    error?:        string;
    event:         PastConversationsResultMessageEvent;
    request_id:    string;
    success:       boolean;
    truncated:     boolean;
    [property: string]: any;
...
export enum PastConversationsResultMessageEvent {
    PastConversationsResult = "past_conversations_result",
}
...
export interface PresentCloseMessage {
    cmd:             PresentCloseMessageCmd;
    presentation_id: string;
    [property: string]: any;
}

export enum PresentCloseMessageCmd {
    PresentClose = "present_close",
}

export interface PresentCloseResultMessage {
    error?:          string;
    event:           PresentCloseResultMessageEvent;
    presentation_id: string;
    success:         boolean;
    [property: string]: any;
}

export enum PresentCloseResultMessageEvent {
    PresentCloseResult = "present_close_result",
}
...
export interface PtyInputProbeResultMessage {
    error?:            string;
    event:             PtyInputProbeResultMessageEvent;
    id:                string;
    probe_id:          string;
    success:           boolean;
...
export enum PtyInputProbeResultMessageEvent {
    PtyInputProbeResult = "pty_input_probe_result",
}
...
export enum ReloadSessionMessageCmd {
    ReloadSession = "reload_session",
}

export interface ReloadSessionResultMessage {
    error?:  string;
    event:   ReloadSessionResultMessageEvent;
    id:      string;
    success: boolean;
    [property: string]: any;
}

export enum ReloadSessionResultMessageEvent {
    ReloadSessionResult = "reload_session_result",
}
...
export interface ActivityStatusResultObject {
    enabled:       boolean;
    error?:        string;
    presence_tier: string;
    sessions:      SessionElement[];
...
export interface JournalAppendResultObject {
    hash:     string;
    rel_path: string;
    [property: string]: any;
}
...
export interface SeedNoteResultMessage {
    error?:     string;
    event:      SeedNoteResultMessageEvent;
    note?:      Note;
    request_id: string;
    success:    boolean;
    [property: string]: any;
...
export enum SeedNoteResultMessageEvent {
    SeedNoteResult = "seed_note_result",
}
...
export interface SeedTransitionResultMessage {
    error?:     string;
    event:      SeedTransitionResultMessageEvent;
    request_id: string;
    seed?:      SeedElement;
    success:    boolean;
    [property: string]: any;
...
export enum SeedTransitionResultMessageEvent {
    SeedTransitionResult = "seed_transition_result",
}
...
export enum SeedWatchMessageCmd {
    SeedWatch = "seed_watch",
}
...
export interface SessionAnnotationsClearMessage {
    cmd:        SessionAnnotationsClearMessageCmd;
    generation: number;
    request_id: string;
    session_id: string;
    [property: string]: any;
...
export enum SessionAnnotationsClearMessageCmd {
    SessionAnnotationsClear = "session_annotations_clear",
}

export interface SessionAnnotationsClearResultMessage {
    error?:     string;
    event:      SessionAnnotationsClearResultMessageEvent;
    generation: number;
    request_id: string;
    session_id: string;
    success:    boolean;
...
export enum SessionAnnotationsClearResultMessageEvent {
    SessionAnnotationsClearResult = "session_annotations_clear_result",
}

export interface SessionAnnotationsGetMessage {
    cmd:        SessionAnnotationsGetMessageCmd;
    request_id: string;
    session_id: string;
    [property: string]: any;
}

export enum SessionAnnotationsGetMessageCmd {
    SessionAnnotationsGet = "session_annotations_get",
}

export interface SessionAnnotationsGetResultMessage {
...
export enum SessionAnnotationsGetResultMessageEvent {
    SessionAnnotationsGetResult = "session_annotations_get_result",
}

export interface SessionAnnotationsSaveMessage {
    annotations: SessionAnnotationsGetResultMessageAnnotation[];
...
export enum SessionAnnotationsSaveMessageCmd {
    SessionAnnotationsSave = "session_annotations_save",
}

export interface SessionAnnotationsSaveResultMessage {
    error?:     string;
    event:      SessionAnnotationsSaveResultMessageEvent;
    generation: number;
    request_id: string;
    session_id: string;
    stale?:     boolean;
...
export enum SessionAnnotationsSaveResultMessageEvent {
    SessionAnnotationsSaveResult = "session_annotations_save_result",
}

export interface SessionAnnotationsSubmitMessage {
    cmd:        SessionAnnotationsSubmitMessageCmd;
    request_id: string;
    session_id: string;
    text:       string;
    [property: string]: any;
...
export enum SessionAnnotationsSubmitMessageCmd {
    SessionAnnotationsSubmit = "session_annotations_submit",
}

export interface SessionAnnotationsSubmitResultMessage {
    error?:     string;
    event:      SessionAnnotationsSubmitResultMessageEvent;
    request_id: string;
    session_id: string;
    status:     string;
    success:    boolean;
...
export interface SessionMessagesChangedMessage {
    event:      SessionMessagesChangedMessageEvent;
    session_id: string;
    [property: string]: any;
}

export enum SessionMessagesChangedMessageEvent {
    SessionMessagesChanged = "session_messages_changed",
}

export interface SessionMessagesGetMessage {
    cmd:        SessionMessagesGetMessageCmd;
    request_id: string;
    session_id: string;
    [property: string]: any;
}

export enum SessionMessagesGetMessageCmd {
    SessionMessagesGet = "session_messages_get",
}

export interface SessionMessagesGetResultMessage {
    detail?:    string;
    error?:     string;
    event:      SessionMessagesGetResultMessageEvent;
...
export enum SessionMessagesGetResultMessageEvent {
    SessionMessagesGetResult = "session_messages_get_result",
}
...
export enum SessionMessageWindowStatus {
...
export enum SetClientPresenceMessageCmd {
    SetClientPresence = "set_client_presence",
}
...
export enum SetTerminalThemeMessageCmd {
...
export interface SettleTurnMessage {
    cmd:        SettleTurnMessageCmd;
    session_id: string;
    [property: string]: any;
}
...
export enum UninstallPluginMessageCmd {
...
export class Convert {
    public static toActivityStatusMessage(json: string): ActivityStatusMessage {
        return cast(JSON.parse(json), r("ActivityStatusMessage"));
    }

    public static activityStatusMessageToJson(value: ActivityStatusMessage): string {
        return JSON.stringify(uncast(value, r("ActivityStatusMessage")), null, 2);
    }

    public static toActivityStatusResult(json: string): ActivityStatusResult {
        return cast(JSON.parse(json), r("ActivityStatusResult"));
    }

    public static activityStatusResultToJson(value: ActivityStatusResult): string {
        return JSON.stringify(uncast(value, r("ActivityStatusResult")), null, 2);
    }

    public static toActivityStatusSession(json: string): ActivityStatusSession {
        return cast(JSON.parse(json), r("ActivityStatusSession"));
    }
    ...
    public static toAgentAttachMessage(json: string): AgentAttachMessage {
        return cast(JSON.parse(json), r("AgentAttachMessage"));
    }

    public static agentAttachMessageToJson(value: AgentAttachMessage): string {
        return JSON.stringify(uncast(value, r("AgentAttachMessage")), null, 2);
    }

    public static toAgentClearQueueMessage(json: string): AgentClearQueueMessage {
        return cast(JSON.parse(json), r("AgentClearQueueMessage"));
    }

    public static agentClearQueueMessageToJson(value: AgentClearQueueMessage): string {
        return JSON.stringify(uncast(value, r("AgentClearQueueMessage")), null, 2);
    }
    ...
    public static toAgentHistoryMessage(json: string): AgentHistoryMessage {
        return cast(JSON.parse(json), r("AgentHistoryMessage"));
    }
    ...
    public static toAgentPromptMessage(json: string): AgentPromptMessage {
        return cast(JSON.parse(json), r("AgentPromptMessage"));
    }

    public static agentPromptMessageToJson(value: AgentPromptMessage): string {
        return JSON.stringify(uncast(value, r("AgentPromptMessage")), null, 2);
    }

    public static toAgentSetModelMessage(json: string): AgentSetModelMessage {
        return cast(JSON.parse(json), r("AgentSetModelMessage"));
    }

    public static agentSetModelMessageToJson(value: AgentSetModelMessage): string {
        return JSON.stringify(uncast(value, r("AgentSetModelMessage")), null, 2);
    }

    public static toAgentToolDetailMessage(json: string): AgentToolDetailMessage {
        return cast(JSON.parse(json), r("AgentToolDetailMessage"));
    }
    ...
    public static toAttachBlock(json: string): AttachBlock {
        return cast(JSON.parse(json), r("AttachBlock"));
    }

    public static attachBlockToJson(value: AttachBlock): string {
        return JSON.stringify(uncast(value, r("AttachBlock")), null, 2);
    }
    ...
    public static toAttachSnapshot(json: string): AttachSnapshot {
        return cast(JSON.parse(json), r("AttachSnapshot"));
    }

    public static attachSnapshotToJson(value: AttachSnapshot): string {
        return JSON.stringify(uncast(value, r("AttachSnapshot")), null, 2);
    }
    ...
    public static toAutomationCleanupMessage(json: string): AutomationCleanupMessage {
        return cast(JSON.parse(json), r("AutomationCleanupMessage"));
    }

    public static automationCleanupMessageToJson(value: AutomationCleanupMessage): string {
    ...
    public static automationDeleteMessageToJson(value: AutomationDeleteMessage): string {
    ...
    public static toAutomationProvenance(json: string): AutomationProvenance {
        return cast(JSON.parse(json), r("AutomationProvenance"));
    }

    public static automationProvenanceToJson(value: AutomationProvenance): string {
        return JSON.stringify(uncast(value, r("AutomationProvenance")), null, 2);
    }
    ...
    public static toClearSessionActivityMessage(json: string): ClearSessionActivityMessage {
        return cast(JSON.parse(json), r("ClearSessionActivityMessage"));
    }

    public static clearSessionActivityMessageToJson(value: ClearSessionActivityMessage): string {
        return JSON.stringify(uncast(value, r("ClearSessionActivityMessage")), null, 2);
    }
    ...
    public static toClientEvictionNoticeMessage(json: string): ClientEvictionNoticeMessage {
        return cast(JSON.parse(json), r("ClientEvictionNoticeMessage"));
    }

    public static clientEvictionNoticeMessageToJson(value: ClientEvictionNoticeMessage): string {
        return JSON.stringify(uncast(value, r("ClientEvictionNoticeMessage")), null, 2);
    }
    ...
    public static toFilesEditedMessage(json: string): FilesEditedMessage {
        return cast(JSON.parse(json), r("FilesEditedMessage"));
    }

    public static filesEditedMessageToJson(value: FilesEditedMessage): string {
        return JSON.stringify(uncast(value, r("FilesEditedMessage")), null, 2);
    }
    ...
    public static toFSDeleteMessage(json: string): FSDeleteMessage {
        return cast(JSON.parse(json), r("FSDeleteMessage"));
    }

    public static fSDeleteMessageToJson(value: FSDeleteMessage): string {
        return JSON.stringify(uncast(value, r("FSDeleteMessage")), null, 2);
    }

    public static toFSDeleteResult(json: string): FSDeleteResult {
        return cast(JSON.parse(json), r("FSDeleteResult"));
    }

    public static fSDeleteResultToJson(value: FSDeleteResult): string {
        return JSON.stringify(uncast(value, r("FSDeleteResult")), null, 2);
    }

    public static toFSDeleteResultMessage(json: string): FSDeleteResultMessage {
        return cast(JSON.parse(json), r("FSDeleteResultMessage"));
    }

    public static fSDeleteResultMessageToJson(value: FSDeleteResultMessage): string {
        return JSON.stringify(uncast(value, r("FSDeleteResultMessage")), null, 2);
    }
    ...
    public static toFSRenameMessage(json: string): FSRenameMessage {
        return cast(JSON.parse(json), r("FSRenameMessage"));
    }

    public static fSRenameMessageToJson(value: FSRenameMessage): string {
        return JSON.stringify(uncast(value, r("FSRenameMessage")), null, 2);
    }

    public static toFSRenameResult(json: string): FSRenameResult {
        return cast(JSON.parse(json), r("FSRenameResult"));
    }

    public static fSRenameResultToJson(value: FSRenameResult): string {
        return JSON.stringify(uncast(value, r("FSRenameResult")), null, 2);
    }

    public static toFSRenameResultMessage(json: string): FSRenameResultMessage {
        return cast(JSON.parse(json), r("FSRenameResultMessage"));
    }

    public static fSRenameResultMessageToJson(value: FSRenameResultMessage): string {
    ...
    public static toHookCompactionMessage(json: string): HookCompactionMessage {
        return cast(JSON.parse(json), r("HookCompactionMessage"));
    }

    public static hookCompactionMessageToJson(value: HookCompactionMessage): string {
        return JSON.stringify(uncast(value, r("HookCompactionMessage")), null, 2);
    }

    public static toHookNotificationMessage(json: string): HookNotificationMessage {
        return cast(JSON.parse(json), r("HookNotificationMessage"));
    }

    public static hookNotificationMessageToJson(value: HookNotificationMessage): string {
        return JSON.stringify(uncast(value, r("HookNotificationMessage")), null, 2);
    }

    public static toHookStopFailureMessage(json: string): HookStopFailureMessage {
        return cast(JSON.parse(json), r("HookStopFailureMessage"));
    }

    public static hookStopFailureMessageToJson(value: HookStopFailureMessage): string {
        return JSON.stringify(uncast(value, r("HookStopFailureMessage")), null, 2);
    }
    ...
    public static toInstallBundledPluginMessage(json: string): InstallBundledPluginMessage {
        return cast(JSON.parse(json), r("InstallBundledPluginMessage"));
    }

    public static installBundledPluginMessageToJson(value: InstallBundledPluginMessage): string {
        return JSON.stringify(uncast(value, r("InstallBundledPluginMessage")), null, 2);
    }
    ...
    public static toJournalAppendMessage(json: string): JournalAppendMessage {
        return cast(JSON.parse(json), r("JournalAppendMessage"));
    }

    public static journalAppendMessageToJson(value: JournalAppendMessage): string {
        return JSON.stringify(uncast(value, r("JournalAppendMessage")), null, 2);
    }

    public static toJournalAppendResult(json: string): JournalAppendResult {
        return cast(JSON.parse(json), r("JournalAppendResult"));
    }

    public static journalAppendResultToJson(value: JournalAppendResult): string {
        return JSON.stringify(uncast(value, r("JournalAppendResult")), null, 2);
    }
    ...
    public static toListPastConversationsMessage(json: string): ListPastConversationsMessage {
        return cast(JSON.parse(json), r("ListPastConversationsMessage"));
    }

    public static listPastConversationsMessageToJson(value: ListPastConversationsMessage): string {
        return JSON.stringify(uncast(value, r("ListPastConversationsMessage")), null, 2);
    }
    ...
    public static toMarkdownAnnotation(json: string): MarkdownAnnotation {
        return cast(JSON.parse(json), r("MarkdownAnnotation"));
    }

    public static markdownAnnotationToJson(value: MarkdownAnnotation): string {
        return JSON.stringify(uncast(value, r("MarkdownAnnotation")), null, 2);
    }

    public static toMarkdownAnnotationAnchor(json: string): MarkdownAnnotationAnchor {
        return cast(JSON.parse(json), r("MarkdownAnnotationAnchor"));
    }

    public static markdownAnnotationAnchorToJson(value: MarkdownAnnotationAnchor): string {
        return JSON.stringify(uncast(value, r("MarkdownAnnotationAnchor")), null, 2);
    }

    public static toMarkdownAnnotationsClearMessage(json: string): MarkdownAnnotationsClearMessage {
        return cast(JSON.parse(json), r("MarkdownAnnotationsClearMessage"));
    }

    public static markdownAnnotationsClearMessageToJson(value: MarkdownAnnotationsClearMessage): string {
        return JSON.stringify(uncast(value, r("MarkdownAnnotationsClearMessage")), null, 2);
    }

    public static toMarkdownAnnotationsClearResultMessage(json: string): MarkdownAnnotationsClearResultMessage {
        return cast(JSON.parse(json), r("MarkdownAnnotationsClearResultMessage"));
    }

    public static markdownAnnotationsClearResultMessageToJson(value: MarkdownAnnotationsClearResultMessage): string {
        return JSON.stringify(uncast(value, r("MarkdownAnnotationsClearResultMessage")), null, 2);
    }

    public static toMarkdownAnnotationsGetMessage(json: string): MarkdownAnnotationsGetMessage {
        return cast(JSON.parse(json), r("MarkdownAnnotationsGetMessage"));
    }

    public static markdownAnnotationsGetMessageToJson(value: MarkdownAnnotationsGetMessage): string {
        return JSON.stringify(uncast(value, r("MarkdownAnnotationsGetMessage")), null, 2);
    }

    public static toMarkdownAnnotationsGetResultMessage(json: string): MarkdownAnnotationsGetResultMessage {
        return cast(JSON.parse(json), r("MarkdownAnnotationsGetResultMessage"));
    }

    public static markdownAnnotationsGetResultMessageToJson(value: MarkdownAnnotationsGetResultMessage): string {
        return JSON.stringify(uncast(value, r("MarkdownAnnotationsGetResultMessage")), null, 2);
    }

    public static toMarkdownAnnotationsSaveMessage(json: string): MarkdownAnnotationsSaveMessage {
        return cast(JSON.parse(json), r("MarkdownAnnotationsSaveMessage"));
    }

    public static markdownAnnotationsSaveMessageToJson(value: MarkdownAnnotationsSaveMessage): string {
        return JSON.stringify(uncast(value, r("MarkdownAnnotationsSaveMessage")), null, 2);
    }

    public static toMarkdownAnnotationsSaveResultMessage(json: string): MarkdownAnnotationsSaveResultMessage {
        return cast(JSON.parse(json), r("MarkdownAnnotationsSaveResultMessage"));
    }

    public static markdownAnnotationsSaveResultMessageToJson(value: MarkdownAnnotationsSaveResultMessage): string {
        return JSON.stringify(uncast(value, r("MarkdownAnnotationsSaveResultMessage")), null, 2);
    }

    public static toMarkdownAnnotationsSubmitMessage(json: string): MarkdownAnnotationsSubmitMessage {
        return cast(JSON.parse(json), r("MarkdownAnnotationsSubmitMessage"));
    }

    public static markdownAnnotationsSubmitMessageToJson(value: MarkdownAnnotationsSubmitMessage): string {
        return JSON.stringify(uncast(value, r("MarkdownAnnotationsSubmitMessage")), null, 2);
    }

    public static toMarkdownAnnotationsSubmitResultMessage(json: string): MarkdownAnnotationsSubmitResultMessage {
        return cast(JSON.parse(json), r("MarkdownAnnotationsSubmitResultMessage"));
    }

    public static markdownAnnotationsSubmitResultMessageToJson(value: MarkdownAnnotationsSubmitResultMessage): string {
        return JSON.stringify(uncast(value, r("MarkdownAnnotationsSubmitResultMessage")), null, 2);
    }
    ...
    public static toOpenMarkdownResultMessage(json: string): OpenMarkdownResultMessage {
        return cast(JSON.parse(json), r("OpenMarkdownResultMessage"));
    }
    ...
    public static openSentFilesMessageToJson(value: OpenSentFilesMessage): string {
        return JSON.stringify(uncast(value, r("OpenSentFilesMessage")), null, 2);
    }
    ...
    public static pastConversationToJson(value: PastConversation): string {
        return JSON.stringify(uncast(value, r("PastConversation")), null, 2);
    }

    public static toPastConversationsResultMessage(json: string): PastConversationsResultMessage {
        return cast(JSON.parse(json), r("PastConversationsResultMessage"));
    }

    public static pastConversationsResultMessageToJson(value: PastConversationsResultMessage): string {
        return JSON.stringify(uncast(value, r("PastConversationsResultMessage")), null, 2);
    }
    ...
    public static toPresentCloseMessage(json: string): PresentCloseMessage {
        return cast(JSON.parse(json), r("PresentCloseMessage"));
    }

    public static presentCloseMessageToJson(value: PresentCloseMessage): string {
        return JSON.stringify(uncast(value, r("PresentCloseMessage")), null, 2);
    }

    public static toPresentCloseResultMessage(json: string): PresentCloseResultMessage {
        return cast(JSON.parse(json), r("PresentCloseResultMessage"));
    }

    public static presentCloseResultMessageToJson(value: PresentCloseResultMessage): string {
        return JSON.stringify(uncast(value, r("PresentCloseResultMessage")), null, 2);
    }
    ...
    public static toPtyInputProbeResultMessage(json: string): PtyInputProbeResultMessage {
        return cast(JSON.parse(json), r("PtyInputProbeResultMessage"));
    }

    public static ptyInputProbeResultMessageToJson(value: PtyInputProbeResultMessage): string {
        return JSON.stringify(uncast(value, r("PtyInputProbeResultMessage")), null, 2);
    }
    ...
    public static toPullRequestProvenance(json: string): PullRequestProvenance {
        return cast(JSON.parse(json), r("PullRequestProvenance"));
    }

    public static pullRequestProvenanceToJson(value: PullRequestProvenance): string {
        return JSON.stringify(uncast(value, r("PullRequestProvenance")), null, 2);
    }
    ...
    public static reloadSessionMessageToJson(value: ReloadSessionMessage): string {
        return JSON.stringify(uncast(value, r("ReloadSessionMessage")), null, 2);
    }

    public static toReloadSessionResultMessage(json: string): ReloadSessionResultMessage {
        return cast(JSON.parse(json), r("ReloadSessionResultMessage"));
    }

    public static reloadSessionResultMessageToJson(value: ReloadSessionResultMessage): string {
        return JSON.stringify(uncast(value, r("ReloadSessionResultMessage")), null, 2);
    }
    ...
    public static toSeedNoteResultMessage(json: string): SeedNoteResultMessage {
        return cast(JSON.parse(json), r("SeedNoteResultMessage"));
    }

    public static seedNoteResultMessageToJson(value: SeedNoteResultMessage): string {
        return JSON.stringify(uncast(value, r("SeedNoteResultMessage")), null, 2);
    }
    ...
    public static toSeedTransitionResultMessage(json: string): SeedTransitionResultMessage {
        return cast(JSON.parse(json), r("SeedTransitionResultMessage"));
    }

    public static seedTransitionResultMessageToJson(value: SeedTransitionResultMessage): string {
        return JSON.stringify(uncast(value, r("SeedTransitionResultMessage")), null, 2);
    }
    ...
    public static toSeedWatchMessage(json: string): SeedWatchMessage {
        return cast(JSON.parse(json), r("SeedWatchMessage"));
    }

    public static seedWatchMessageToJson(value: SeedWatchMessage): string {
        return JSON.stringify(uncast(value, r("SeedWatchMessage")), null, 2);
    }

    public static toSeedWatchResult(json: string): SeedWatchResult {
        return cast(JSON.parse(json), r("SeedWatchResult"));
    }

    public static seedWatchResultToJson(value: SeedWatchResult): string {
        return JSON.stringify(uncast(value, r("SeedWatchResult")), null, 2);
    }
    ...
    public static toSessionAnnotation(json: string): SessionAnnotation {
        return cast(JSON.parse(json), r("SessionAnnotation"));
    }

    public static sessionAnnotationToJson(value: SessionAnnotation): string {
        return JSON.stringify(uncast(value, r("SessionAnnotation")), null, 2);
    }

    public static toSessionAnnotationsClearMessage(json: string): SessionAnnotationsClearMessage {
        return cast(JSON.parse(json), r("SessionAnnotationsClearMessage"));
    }

    public static sessionAnnotationsClearMessageToJson(value: SessionAnnotationsClearMessage): string {
        return JSON.stringify(uncast(value, r("SessionAnnotationsClearMessage")), null, 2);
    }

    public static toSessionAnnotationsClearResultMessage(json: string): SessionAnnotationsClearResultMessage {
        return cast(JSON.parse(json), r("SessionAnnotationsClearResultMessage"));
    }

    public static sessionAnnotationsClearResultMessageToJson(value: SessionAnnotationsClearResultMessage): string {
        return JSON.stringify(uncast(value, r("SessionAnnotationsClearResultMessage")), null, 2);
    }

    public static toSessionAnnotationsGetMessage(json: string): SessionAnnotationsGetMessage {
        return cast(JSON.parse(json), r("SessionAnnotationsGetMessage"));
    }

    public static sessionAnnotationsGetMessageToJson(value: SessionAnnotationsGetMessage): string {
        return JSON.stringify(uncast(value, r("SessionAnnotationsGetMessage")), null, 2);
    }

    public static toSessionAnnotationsGetResultMessage(json: string): SessionAnnotationsGetResultMessage {
        return cast(JSON.parse(json), r("SessionAnnotationsGetResultMessage"));
    }

    public static sessionAnnotationsGetResultMessageToJson(value: SessionAnnotationsGetResultMessage): string {
        return JSON.stringify(uncast(value, r("SessionAnnotationsGetResultMessage")), null, 2);
    }

    public static toSessionAnnotationsSaveMessage(json: string): SessionAnnotationsSaveMessage {
        return cast(JSON.parse(json), r("SessionAnnotationsSaveMessage"));
    }

    public static sessionAnnotationsSaveMessageToJson(value: SessionAnnotationsSaveMessage): string {
        return JSON.stringify(uncast(value, r("SessionAnnotationsSaveMessage")), null, 2);
    }

    public static toSessionAnnotationsSaveResultMessage(json: string): SessionAnnotationsSaveResultMessage {
        return cast(JSON.parse(json), r("SessionAnnotationsSaveResultMessage"));
    }

    public static sessionAnnotationsSaveResultMessageToJson(value: SessionAnnotationsSaveResultMessage): string {
        return JSON.stringify(uncast(value, r("SessionAnnotationsSaveResultMessage")), null, 2);
    }

    public static toSessionAnnotationsSubmitMessage(json: string): SessionAnnotationsSubmitMessage {
        return cast(JSON.parse(json), r("SessionAnnotationsSubmitMessage"));
    }

    public static sessionAnnotationsSubmitMessageToJson(value: SessionAnnotationsSubmitMessage): string {
        return JSON.stringify(uncast(value, r("SessionAnnotationsSubmitMessage")), null, 2);
    }

    public static toSessionAnnotationsSubmitResultMessage(json: string): SessionAnnotationsSubmitResultMessage {
        return cast(JSON.parse(json), r("SessionAnnotationsSubmitResultMessage"));
    }

    public static sessionAnnotationsSubmitResultMessageToJson(value: SessionAnnotationsSubmitResultMessage): string {
    ...
    public static toSessionMessage(json: string): SessionMessage {
        return cast(JSON.parse(json), r("SessionMessage"));
    }

    public static sessionMessageToJson(value: SessionMessage): string {
        return JSON.stringify(uncast(value, r("SessionMessage")), null, 2);
    }

    public static toSessionMessageWindowStatus(json: string): SessionMessageWindowStatus {
        return cast(JSON.parse(json), r("SessionMessageWindowStatus"));
    }

    public static sessionMessageWindowStatusToJson(value: SessionMessageWindowStatus): string {
        return JSON.stringify(uncast(value, r("SessionMessageWindowStatus")), null, 2);
    }

    public static toSessionMessagesChangedMessage(json: string): SessionMessagesChangedMessage {
        return cast(JSON.parse(json), r("SessionMessagesChangedMessage"));
    }

    public static sessionMessagesChangedMessageToJson(value: SessionMessagesChangedMessage): string {
        return JSON.stringify(uncast(value, r("SessionMessagesChangedMessage")), null, 2);
    }

    public static toSessionMessagesGetMessage(json: string): SessionMessagesGetMessage {
        return cast(JSON.parse(json), r("SessionMessagesGetMessage"));
    }

    public static sessionMessagesGetMessageToJson(value: SessionMessagesGetMessage): string {
        return JSON.stringify(uncast(value, r("SessionMessagesGetMessage")), null, 2);
    }

    public static toSessionMessagesGetResultMessage(json: string): SessionMessagesGetResultMessage {
        return cast(JSON.parse(json), r("SessionMessagesGetResultMessage"));
    }

    public static sessionMessagesGetResultMessageToJson(value: SessionMessagesGetResultMessage): string {
    ...
    public static setClientPresenceMessageToJson(value: SetClientPresenceMessage): string {
        return JSON.stringify(uncast(value, r("SetClientPresenceMessage")), null, 2);
    }
    ...
    public static toSetTerminalThemeMessage(json: string): SetTerminalThemeMessage {
        return cast(JSON.parse(json), r("SetTerminalThemeMessage"));
    }
    ...
    public static toSettleTurnMessage(json: string): SettleTurnMessage {
        return cast(JSON.parse(json), r("SettleTurnMessage"));
    }
    ...
    public static uninstallPluginMessageToJson(value: UninstallPluginMessage): string {
        return JSON.stringify(uncast(value, r("UninstallPluginMessage")), null, 2);
    }
...
const typeMap: any = {
    "ActivityStatusMessage": o([
        { json: "cmd", js: "cmd", typ: r("ActivityStatusMessageCmd") },
    ], "any"),
    "ActivityStatusResult": o([
    ...
    "AgentAttachMessage": o([
        { json: "cmd", js: "cmd", typ: r("AgentAttachMessageCmd") },
        { json: "id", js: "id", typ: "" },
    ], "any"),
    "AgentClearQueueMessage": o([
        { json: "cmd", js: "cmd", typ: r("AgentClearQueueMessageCmd") },
        { json: "id", js: "id", typ: "" },
    ], "any"),
    "AgentEventMessage": o([
        { json: "body", js: "body", typ: m("any") },
        { json: "event", js: "event", typ: r("AgentEventMessageEvent") },
        { json: "id", js: "id", typ: "" },
        { json: "kind", js: "kind", typ: "" },
        { json: "seq", js: "seq", typ: 0 },
    ], "any"),
    "AgentHistoryMessage": o([
    ...
    "AgentSetModelMessage": o([
        { json: "cmd", js: "cmd", typ: r("AgentSetModelMessageCmd") },
        { json: "id", js: "id", typ: "" },
        { json: "model", js: "model", typ: "" },
    ], "any"),
    "AgentToolDetailMessage": o([
        { json: "call_id", js: "call_id", typ: "" },
        { json: "cmd", js: "cmd", typ: r("AgentToolDetailMessageCmd") },
    ...
    "AttachBlock": o([
        ...
        { json: "end_row", js: "end_row", typ: u(undefined, 0) },
        { json: "exit_code", js: "exit_code", typ: u(undefined, 0) },
        { json: "id", js: "id", typ: 0 },
        { json: "input_col", js: "input_col", typ: u(undefined, 0) },
        { json: "input_row", js: "input_row", typ: u(undefined, 0) },
        { json: "output_start_row", js: "output_start_row", typ: u(undefined, 0) },
    ...
    "AttachResultMessage": o([
        ...
        { json: "pid", js: "pid", typ: u(undefined, 0) },
        { json: "revived", js: "revived", typ: u(undefined, true) },
    ...
    "ClientEvictionNoticeMessage": o([
        { json: "event", js: "event", typ: r("ClientEvictionNoticeMessageEvent") },
        { json: "evicted_at", js: "evicted_at", typ: "" },
        { json: "reason", js: "reason", typ: "" },
        { json: "undelivered_messages", js: "undelivered_messages", typ: 0 },
    ], "any"),
    ...
    "FilesEditedMessage": o([
        { json: "cmd", js: "cmd", typ: r("FilesEditedMessageCmd") },
        { json: "id", js: "id", typ: "" },
    ...
    "FSDeleteResultMessage": o([
        { json: "error", js: "error", typ: u(undefined, "") },
        { json: "event", js: "event", typ: r("FSDeleteResultMessageEvent") },
        { json: "request_id", js: "request_id", typ: "" },
        { json: "result", js: "result", typ: u(undefined, r("FSDeleteResultMessageResult")) },
        { json: "success", js: "success", typ: true },
    ], "any"),
    "FSDeleteResultMessageResult": o([
        { json: "path", js: "path", typ: "" },
    ], "any"),
    "FSEntry": o([
        { json: "is_dir", js: "is_dir", typ: true },
    ...
    "FSRenameResultMessage": o([
        { json: "error", js: "error", typ: u(undefined, "") },
        { json: "event", js: "event", typ: r("FSRenameResultMessageEvent") },
        { json: "request_id", js: "request_id", typ: "" },
        { json: "result", js: "result", typ: u(undefined, r("FSRenameResultMessageResult")) },
        { json: "success", js: "success", typ: true },
    ], "any"),
    "FSRenameResultMessageResult": o([
        { json: "new_path", js: "new_path", typ: "" },
        { json: "path", js: "path", typ: "" },
    ], "any"),
    "FSUnwatchMessage": o([
    ...
    "HookCompactionMessage": o([
        { json: "active", js: "active", typ: true },
        { json: "cmd", js: "cmd", typ: r("HookCompactionMessageCmd") },
        { json: "id", js: "id", typ: "" },
        { json: "trigger", js: "trigger", typ: u(undefined, "") },
    ], "any"),
    "HookNotificationMessage": o([
        { json: "cmd", js: "cmd", typ: r("HookNotificationMessageCmd") },
        { json: "id", js: "id", typ: "" },
        { json: "message", js: "message", typ: u(undefined, "") },
        { json: "notification_type", js: "notification_type", typ: "" },
    ], "any"),
    "HookStopFailureMessage": o([
        { json: "cmd", js: "cmd", typ: r("HookStopFailureMessageCmd") },
        { json: "error_message", js: "error_message", typ: u(undefined, "") },
        { json: "error_type", js: "error_type", typ: "" },
        { json: "id", js: "id", typ: "" },
    ], "any"),
    ...
    "InstallBundledPluginMessage": o([
        { json: "cmd", js: "cmd", typ: r("InstallBundledPluginMessageCmd") },
        { json: "name", js: "name", typ: "" },
    ], "any"),
    ...
    "ListPastConversationsMessage": o([
        { json: "cmd", js: "cmd", typ: r("ListPastConversationsMessageCmd") },
        { json: "request_id", js: "request_id", typ: "" },
    ], "any"),
    ...
    "MarkdownAnnotation": o([
        ...
        { json: "quick_label_text", js: "quick_label_text", typ: u(undefined, "") },
        { json: "quick_label_tip", js: "quick_label_tip", typ: u(undefined, "") },
        { json: "text", js: "text", typ: u(undefined, "") },
        { json: "type", js: "type", typ: "" },
    ], "any"),
    "Anchor": o([
    ...
    "PastConversation": o([
        ...
        { json: "live", js: "live", typ: true },
        { json: "modified", js: "modified", typ: 0 },
        { json: "preview", js: "preview", typ: "" },
        { json: "session_id", js: "session_id", typ: "" },
    ], "any"),
    "PastConversationsResultMessage": o([
        { json: "conversations", js: "conversations", typ: a(r("ConversationElement")) },
        { json: "error", js: "error", typ: u(undefined, "") },
        { json: "event", js: "event", typ: r("PastConversationsResultMessageEvent") },
        { json: "request_id", js: "request_id", typ: "" },
        { json: "success", js: "success", typ: true },
        { json: "truncated", js: "truncated", typ: true },
    ], "any"),
    "ConversationElement": o([
        { json: "bytes", js: "bytes", typ: 0 },
        { json: "cwd", js: "cwd", typ: "" },
        { json: "file", js: "file", typ: "" },
        { json: "live", js: "live", typ: true },
    ...
    "PluginInfo": o([
        ...
        { json: "can_install", js: "can_install", typ: true },
        { json: "can_uninstall", js: "can_uninstall", typ: true },
        { json: "connected", js: "connected", typ: true },
        { json: "description", js: "description", typ: u(undefined, "") },
        { json: "dir", js: "dir", typ: "" },
    ...
    "PresentCloseResultMessage": o([
        { json: "error", js: "error", typ: u(undefined, "") },
        { json: "event", js: "event", typ: r("PresentCloseResultMessageEvent") },
        { json: "presentation_id", js: "presentation_id", typ: "" },
        { json: "success", js: "success", typ: true },
    ], "any"),
    ...
    "PtyInputProbeResultMessage": o([
        { json: "error", js: "error", typ: u(undefined, "") },
        { json: "event", js: "event", typ: r("PtyInputProbeResultMessageEvent") },
        { json: "id", js: "id", typ: "" },
        { json: "probe_id", js: "probe_id", typ: "" },
        { json: "success", js: "success", typ: true },
        { json: "write_duration_us", js: "write_duration_us", typ: 0 },
    ], "any"),
    "PtyOutputMessage": o([
        { json: "data", js: "data", typ: "" },
    ...
    "ReloadSessionResultMessage": o([
        { json: "error", js: "error", typ: u(undefined, "") },
        { json: "event", js: "event", typ: r("ReloadSessionResultMessageEvent") },
        { json: "id", js: "id", typ: "" },
        { json: "success", js: "success", typ: true },
    ], "any"),
    ...
    "SeedNoteResultMessage": o([
        { json: "error", js: "error", typ: u(undefined, "") },
        { json: "event", js: "event", typ: r("SeedNoteResultMessageEvent") },
        { json: "note", js: "note", typ: u(undefined, r("Note")) },
        { json: "request_id", js: "request_id", typ: "" },
        { json: "success", js: "success", typ: true },
    ], "any"),
    "SeedNotesMessage": o([
    ...
    "SeedTransitionResultMessage": o([
        { json: "error", js: "error", typ: u(undefined, "") },
        { json: "event", js: "event", typ: r("SeedTransitionResultMessageEvent") },
        { json: "request_id", js: "request_id", typ: "" },
        { json: "seed", js: "seed", typ: u(undefined, r("SeedElement")) },
        { json: "success", js: "success", typ: true },
    ], "any"),
    "SeedVar": o([
        { json: "default", js: "default", typ: u(undefined, "") },
    ...
    "SessionAnnotationsClearMessage": o([
        { json: "cmd", js: "cmd", typ: r("SessionAnnotationsClearMessageCmd") },
        { json: "generation", js: "generation", typ: 0 },
        { json: "request_id", js: "request_id", typ: "" },
        { json: "session_id", js: "session_id", typ: "" },
    ], "any"),
    "SessionAnnotationsClearResultMessage": o([
        { json: "error", js: "error", typ: u(undefined, "") },
        { json: "event", js: "event", typ: r("SessionAnnotationsClearResultMessageEvent") },
        { json: "generation", js: "generation", typ: 0 },
        { json: "request_id", js: "request_id", typ: "" },
        { json: "session_id", js: "session_id", typ: "" },
        { json: "success", js: "success", typ: true },
    ], "any"),
    "SessionAnnotationsGetMessage": o([
        { json: "cmd", js: "cmd", typ: r("SessionAnnotationsGetMessageCmd") },
        { json: "request_id", js: "request_id", typ: "" },
        { json: "session_id", js: "session_id", typ: "" },
    ], "any"),
    "SessionAnnotationsGetResultMessage": o([
    ...
    "SessionAnnotationsSaveMessage": o([
        { json: "annotations", js: "annotations", typ: a(r("SessionAnnotationsGetResultMessageAnnotation")) },
    ...
    "SessionAnnotationsSaveResultMessage": o([
        { json: "error", js: "error", typ: u(undefined, "") },
        { json: "event", js: "event", typ: r("SessionAnnotationsSaveResultMessageEvent") },
        { json: "generation", js: "generation", typ: 0 },
        { json: "request_id", js: "request_id", typ: "" },
        { json: "session_id", js: "session_id", typ: "" },
        { json: "stale", js: "stale", typ: u(undefined, true) },
    ...
    "SessionAnnotationsSubmitMessage": o([
        { json: "cmd", js: "cmd", typ: r("SessionAnnotationsSubmitMessageCmd") },
        { json: "request_id", js: "request_id", typ: "" },
        { json: "session_id", js: "session_id", typ: "" },
        { json: "text", js: "text", typ: "" },
    ], "any"),
    "SessionAnnotationsSubmitResultMessage": o([
        { json: "error", js: "error", typ: u(undefined, "") },
        { json: "event", js: "event", typ: r("SessionAnnotationsSubmitResultMessageEvent") },
        { json: "request_id", js: "request_id", typ: "" },
        { json: "session_id", js: "session_id", typ: "" },
        { json: "status", js: "status", typ: "" },
        { json: "success", js: "success", typ: true },
    ...
    "SessionMessagesChangedMessage": o([
        { json: "event", js: "event", typ: r("SessionMessagesChangedMessageEvent") },
        { json: "session_id", js: "session_id", typ: "" },
    ], "any"),
    "SessionMessagesGetMessage": o([
        { json: "cmd", js: "cmd", typ: r("SessionMessagesGetMessageCmd") },
        { json: "request_id", js: "request_id", typ: "" },
        { json: "session_id", js: "session_id", typ: "" },
    ], "any"),
    "SessionMessagesGetResultMessage": o([
        { json: "detail", js: "detail", typ: u(undefined, "") },
        { json: "error", js: "error", typ: u(undefined, "") },
        { json: "event", js: "event", typ: r("SessionMessagesGetResultMessageEvent") },
        { json: "messages", js: "messages", typ: a(r("MessageElement")) },
        { json: "request_id", js: "request_id", typ: "" },
        { json: "session_id", js: "session_id", typ: "" },
        { json: "status", js: "status", typ: r("SessionMessageWindowStatus") },
        { json: "success", js: "success", typ: true },
        { json: "truncated", js: "truncated", typ: true },
    ], "any"),
    "MessageElement": o([
    ...
    "SetClientPresenceMessage": o([
        ...
        { json: "idle_seconds", js: "idle_seconds", typ: u(undefined, 3.14) },
    ...
    "SpawnSessionMessage": o([
        ...
        { json: "label", js: "label", typ: u(undefined, "") },
        { json: "model", js: "model", typ: u(undefined, "") },
        { json: "resume_conversation_file", js: "resume_conversation_file", typ: u(undefined, "") },
    ...
    "ActivityStatusMessageCmd": [
        "activity_status",
    ],
    "AddEndpointMessageCmd": [
        "add_endpoint",
    ],
    "AgentAttachMessageCmd": [
        "agent_attach",
    ],
    "AgentClearQueueMessageCmd": [
        "agent_clear_queue",
    ],
    "AgentEventMessageEvent": [
        "agent_event",
    ],
    ...
    "ClientEvictionNoticeMessageEvent": [
        "client_eviction_notice",
    ],
    ...
    "HookCompactionMessageCmd": [
        "hook_compaction",
    ],
    "HookNotificationMessageCmd": [
        "hook_notification",
    ],
    "HookStopFailureMessageCmd": [
        "hook_stop_failure",
    ],
    ...
    "InstallBundledPluginMessageCmd": [
    ...
    "ListPastConversationsMessageCmd": [
    ...
    "MarkdownAnnotationsClearMessageCmd": [
        "markdown_annotations_clear",
    ],
    "MarkdownAnnotationsClearResultMessageEvent": [
        "markdown_annotations_clear_result",
    ],
    "MarkdownAnnotationsGetMessageCmd": [
        "markdown_annotations_get",
    ],
    "MarkdownAnnotationsGetResultMessageEvent": [
        "markdown_annotations_get_result",
    ],
    "MarkdownAnnotationsSaveMessageCmd": [
        "markdown_annotations_save",
    ],
    "MarkdownAnnotationsSaveResultMessageEvent": [
        "markdown_annotations_save_result",
    ],
    "MarkdownAnnotationsSubmitMessageCmd": [
        "markdown_annotations_submit",
    ],
    "MarkdownAnnotationsSubmitResultMessageEvent": [
        "markdown_annotations_submit_result",
    ],
    "MergePRMessageCmd": [
        "merge_pr",
    ],
    ...
    "PresentCloseResultMessageEvent": [
        "present_close_result",
    ],
    ...
    "PtyInputProbeResultMessageEvent": [
        "pty_input_probe_result",
    ],
    ...
    "ReloadSessionResultMessageEvent": [
        "reload_session_result",
    ],
    ...
    "SeedTransitionResultMessageEvent": [
    ...
    "SessionAnnotationsClearResultMessageEvent": [
        "session_annotations_clear_result",
    ],
    "SessionAnnotationsGetMessageCmd": [
        "session_annotations_get",
    ],
    "SessionAnnotationsGetResultMessageEvent": [
        "session_annotations_get_result",
    ],
    "SessionAnnotationsSaveMessageCmd": [
        "session_annotations_save",
    ],
    "SessionAnnotationsSaveResultMessageEvent": [
        "session_annotations_save_result",
    ],
    "SessionAnnotationsSubmitMessageCmd": [
    ...
    "SessionMessagesChangedMessageEvent": [
        "session_messages_changed",
    ],
    "SessionMessagesGetMessageCmd": [
        "session_messages_get",
    ],
    "SessionMessagesGetResultMessageEvent": [
        "session_messages_get_result",
    ],
    "SessionMessageWindowStatus": [
        "discovering",
        "ready",
        "unavailable",
    ],
